...
public class VideoTool {
     ...
     * 获取视频第一帧
     *
     * @param videoPath 视频路径，可以为 "http://43.139.159.32:8090/dolphin/video/1668915272595.mp4"
    ...
    public static void getVideoFirstImg(String videoPath, String imagePath, String imageType, int angele) throws Exception {
        String videoName = videoPath.substring(videoPath.lastIndexOf(StringPool.VIDEO_SLASH) + 1);
